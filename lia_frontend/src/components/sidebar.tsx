...
export function Sidebar() {
  ...
  return (
    ...
    <aside className={`fixed inset-y-0 left-0 z-40 flex w-[min(18rem,calc(100vw-2rem))] shrink-0 flex-col overflow-y-auto border-r border-zinc-800 bg-zinc-950 p-5 shadow-2xl transition-transform duration-200 sm:p-6 lg:static lg:z-auto lg:w-72 lg:translate-x-0 lg:shadow-none ${open ? "translate-x-0" : "-translate-x-full"}`}>
