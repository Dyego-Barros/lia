...
export default function DashboardPage() {
  ...
  const cards = [
    ...
    { title: "Gasto com materiais", value: money.format(report?.custos_materiais ?? 0), hint: "confirmados e concluídos", icon: PackageOpen, cardClass: "border-violet-200 bg-gradient-to-br from-violet-50 to-white", titleClass: "text-violet-800", iconClass: "bg-violet-100 text-violet-700", hintClass: "text-violet-700" },
